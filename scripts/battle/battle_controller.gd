...
@onready var bottom_skill_bar = $UI/BottomSkillBar
@onready var attack_button_large: Button = $UI/BottomSkillBar/CenterContainer/HBoxContainer/AttackButtonLarge
@onready var skill_button_1: Button = $UI/BottomSkillBar/CenterContainer/HBoxContainer/SkillButton1
@onready var skill_button_2: Button = $UI/BottomSkillBar/CenterContainer/HBoxContainer/SkillButton2
@onready var skill_button_3: Button = $UI/BottomSkillBar/CenterContainer/HBoxContainer/SkillButton3
@onready var end_turn_button_large: Button = $UI/BottomSkillBar/CenterContainer/HBoxContainer/EndTurnButtonLarge
